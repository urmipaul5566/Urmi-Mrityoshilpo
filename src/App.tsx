                ...
                <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                  ...
                  <div className="md:col-span-7 flex flex-col gap-4 items-start">
                    ...
                    <p className="text-xs md:text-sm text-clay-text/80 leading-relaxed font-bangla font-medium">
                      বাংলাদেশি মৃৎশিল্প শুধু গৃহস্থালির জিনিসপত্র বানানোর জন্য নয়, এটি আমাদের সংস্কৃতির গভীর শেকড়। সারা বাংলাদেশের পাল পাড়াগুলোর কুমার পরিবারগুলো যুগ যুগ ধরে এই ঐতিহ্যকে টিকিয়ে রেখেছে। নদীমাতৃক বাংলার দোআঁশ ও এঁটেল মাটি দিয়ে আগুনে পুড়িয়ে তৈরি লাল মাটির পাত্রগুলোর আভিজাত্য যেকোনো আধুনিক আসবাবকে হার মানায়।
                    </p>
                    <button
            ...
            >
              <div className="flex flex-col gap-6 font-bangla text-clay-text text-sm">
                ...
                <div className="space-y-4 leading-relaxed font-medium text-gray-700 bg-white/50 p-6 rounded-3xl border border-clay-secondary/5 shadow-inner">
                  ...
                  <p>
                    আমরা সরাসরি নিজস্ব কারখানা ও সারা বাংলাদেশ থেকে পণ্য সংগ্রহ ও তৈরি করে থাকি। প্রতিটি পণ্য তৈরিতে কোনো প্রকার সীসা বা কৃত্রিম রাসায়নিক রঞ্জক ব্যবহার করা হয় না। নদীর খাঁটি লাল এঁটেল মাটি দিয়ে নিখুঁত খোদাই করা এই তৈজসপত্রগুলো সম্পূর্ণ পরিবেশবান্ধব ও স্বাস্থ্যসম্মত।
                  </p>
                  <p>
